    ...
    <ul class="dropdown-menu absolute hidden text-gray-700 pt-1">
        {#each dropDownOptions as option, i}
            <li
                ...
                class="block w-full bg-gray-100 text-left px-4 py-2 text-sm text-gray-700 hover:bg-gray-200 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900"
            >
                {option}
            </li>
        {/each}
